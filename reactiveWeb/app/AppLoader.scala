...
//import io.getquill.sources.sql.idiom.{ H2Dialect, MySQLDialect }
...
//
//    //    lazy val db = source {
//    //      new AsyncSourceConfig[MySQLDialect, SnakeCase, Connection]("default") {
//    //        override def dataSource: DataSource with Closeable =
//    //          dbApi.database(name).dataSource.asInstanceOf[DataSource with Closeable]
//    //      }
//    //    }
////    lazy val db = source{
////      new AsyncSourceConfig[MySQLDialect, SnakeCase, Connection]("db"){
////      override def dataSource: DataSource with Closeable =
////                dbApi.database(name).dataSource.asInstanceOf[DataSource with Closeable]
////            }
////          }
